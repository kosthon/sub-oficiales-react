...
export default function SceneThree({ visible, changeScene }) {
	return (
		<Entity id='SceneThree' visible={visible}>
			<Sky src='/img/paraiso/parqueadero2.jpg' rotation='0 -130 0' />

			<Entity
				geometry='primitive: plane; width: 0.5; height: 0.5;'
				material='transparent: true; visible: false'
				position='-2.435 0.5 3.908'
				rotation='0 -173.925 -10.000'
				events={{
					mouseenter: e => {
			...
			<Entity
				geometry='primitive: plane; width: 0.5; height: 0.5;'
				material='transparent: true; visible: false'
				position='-4.775 0 -1.014'
				rotation='0 93.337 -10.000'
				events={{
					mouseenter: e => {
						e.target.setAttribute('scale', { x: 1.2, y: 1.2, z: 1.2 });
						e.target.setAttribute(
			...
			<Entity
				...
				position='-1 0 -1'
				scale='1 1 1'
				animation__postition='property: rotation; to: 0 3600 0; dir: alternate; dur: 9200; loop: true;'
			/>
